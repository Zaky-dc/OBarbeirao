...
// GET /api/atendimentos/relatorio → gerar relatório com filtros
router.get("/relatorio", async (req, res) => {
  try {
    ...
    if (telefone)
      filtro["cliente.telefone"] = { $regex: telefone, $options: "i" };
...
// POST /api/atendimentos → registrar atendimento finalizado
